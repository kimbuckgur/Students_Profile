    ...
    return (
        <div className="test">
            ...
            <div id="body_all">
                <div className="name">
                    <h1 id="name_1">이름:</h1>
                    <h2 id="name_2">{Student_Information[5].name}</h2>
                </div>
                <div className="age">
                    <h1 id="age_1">나이:</h1>
                    <h2 id="age_2">{Student_Information[5].age}</h2>
                </div>
                <div className="Major">
                    <h1 id="Major_1">전공:</h1>
                    <h2 id="Major_2">{Student_Information[5].Major}</h2>
                </div>
                <div className="Circles">
                    <h1  id="Circles_1">동아리:</h1>
                    <h2 id="Circles_2">{Student_Information[5].Circles}</h2>
                </div>
            </div>
        </div>)
}
